...
const api = 'b4ceaa53337145bf835a50def09ba4e3';
...
//Passing the joke to Voice Function
function tellme(joke) {
    VoiceRSS.speech({
        key: 'b4ceaa53337145bf835a50def09ba4e3',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0,
...
async function jokeFetcher() {
    try {
        ...
        const url = 'https://v2.jokeapi.dev/joke/Programming,Dark,Pun?blacklistFlags=political&type=single';
...
button.addEventListener('click', jokeFetcher);
